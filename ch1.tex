...
\item[Saving the citation] Insert the bibTeX entry to the file \texttt{bibliography.bib}. On the first line of the entry you should see the short reference name --- from Scholar, it usually looks like \texttt{author2015title} --- you will use that to refer to the citation.
